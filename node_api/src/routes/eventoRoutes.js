...
router.post('/', requireAuth, requirePermission(['administrador', 'editor']), eventoController.createEvento); 
// PUT /api/content/eventos/:id
router.put('/:id', requireAuth, requirePermission(['administrador', 'editor']), eventoController.updateEvento); 
